...
class App extends React.Component {
  ...
  handleRangeSubmit() {
    ...
    this.setState({showMinRange: min, showMaxRange: max })
  }
      ...
      <div>
        ...
        <Controls
          ...
          <UserRangeInputs
            ...
            <li className='range'><span className='min'>Min:  {this.renderMinRange()}</span><span>Max:  {this.renderMaxRange()}</span></li>
      </div>
    )
  }
}
